...
Over recent year the use of wearable devices has increased in the general population [@dhingra2023] allowing comprehensive data collection of behavioral (sleep and physical activity) and physiological (heart rate, ECG, temperature, etc.) [@keshet2023]. Wearable devices opens up of broader and more feasible data collection of heart rate data over long-term period which are less

Study I and II demonstrate the link between long-term HRV and CVD risk, and the stronger association in stages of prediabetes and type 2 diabetes. Thus, a perspective of wearable devices, e.g., smartwatches, is to monitor HRV in individuals at higher cardiometabolic risk and use available HRV measures to guide the progression of cardiometabolic risk. In the Whitehall II study, we demonstrated that a steeper 10-year decrease in 5-minute HRV was linked with higher aortic stiffness development in the subsequent 5 years \[\@schaarup2023\]. Thus, a decreasing tendency detected by smartwatches may help indicate individuals who need interventions.

Multmodal data including heart rate. sleep and physical activity may in combination

HRV

hjertesvigt - progression - HRV - response to adapt to lifestyle and treatment

Standardization and transparency across waerable devices reamins a challenge for implementation of monitoring of heart rate, HRV and it response to behaviour.
