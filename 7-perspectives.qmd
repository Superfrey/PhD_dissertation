...
::: {#fig-smw fig-cap="**Hypothetical scenario of lifestyle and treatment adaptation using HRV in wearable devices**" fig-align="center"}
![](images/smartwatch.png){width="4in"} *(Source: Author)*
:::
