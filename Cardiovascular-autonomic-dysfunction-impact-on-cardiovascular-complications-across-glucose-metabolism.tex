...
air pollution\textsuperscript{1}. Along the causal pathway to CVD, these
risk factors contribute to comorbidities such as obesity, diabetes,
hypertension, and hypercholesterolemia, further accelerating overall CVD
risk. While risk factors are largely shared across CVD types, the
pathogenesis differs, involving structural, signalling, inflammatory,
and dynamic changes in the cardiovascular system.
...
fibers, leading to increased vascular stiffness\textsuperscript{2}. This
...
night hours\textsuperscript{21}. Thus, although long-term HRV may lack
...
HRV\textsuperscript{22}. In population-based cohort studies, despite it
...
observed relationship\textsuperscript{23}.
...
In study II\ldots. Arterial stiffness is not only a structural marker of
vascular ageing but is also dynamically modulated by local endothelial
signals and autonomic nervous system activity. Several studies have
demonstrated a link between elevated sympathetic tone and increased
arterial stiffness. One potential mechanism is that autonomic nervous
...
years\textsuperscript{23}. In study II, we extended this perspective by
...
higher HbA1c values among non-diabetic individuals\textsuperscript{24}.
...
formation can be lowered by reducing sympathetic nerve
density\textsuperscript{25}. In this context, findings from Study II
...
Study\textsuperscript{26}. As plaques develop, the associated increase
in sympathetic nerve density around the arteries could reduce arterial
elasticity. However in a small population of people with type 2
diabetes, it was shown that lower HRV was linked with increase in
...
arteries and thereby inhibiting their elasticity\textsuperscript{23}.
...
response under stress may play a role in ischemia\textsuperscript{29}.
In our week-long recordings, our data likely included episodes of
...
diabetes\textsuperscript{30}. This supports autonomic dysfunctions role
...
attention\textsuperscript{31}. As increased sympathetic nervous system
...
complex\textsuperscript{32}. On one hand, autonomic dysfunction may
reflect the progression of cardiac remodelling and declining cardiac
output. On the other, it may represent complication of autonomic
dysfunction that contributes to cardiac stress, sympathetic
overactivation, and eventual heart failure. Our findings demonstrated
the relationship between autonomic dysfunction and heart failure both
...
pressure\textsuperscript{33}. Therefore, arterial stiffness may have an
...
of the risk was explained by resting heart rate. {[}bridge this with the
discussion paragraph below{]}. Data from the Rotterdam Study showed that
short-term HRV was longitudinally associated with echocardiographic
measures reflecting systolic function. However, the association was
observed in baseline levels rather than in changes over
time\textsuperscript{34}.
...
diabetes\textsuperscript{35}. This suggest regardless of the direction
...
diabetes\textsuperscript{36}. In populations with type 2 diabetes, the
...
CAN as a useful marker to identify individuals at increased risk of
heart failure. However, further studies including echocardiographic
assessments are needed to validate this approach. If confirmed, this
could open the door for targeted interventions based on risk
stratification.
...
{[}\textsuperscript{21}{]}\textsuperscript{37}. However, it remains to
...
{[}\textsuperscript{30}{]}\textsuperscript{38}. In Study II, we observed
...
short-term trials\textsuperscript{39}. This may seem conflicting with
...
Autonomic dysfunction, based on 24-hour heart rate variability, is link
with higher arterial stiffness. The association was present in people
with normal glucose metabolism and becomes stronger with progression to
prediabetes and type 2 diabetes. In people with high risk of diabetes,
long-term HRV over a week was associated with ischemic events, heart
failure and all-cause mortality, demonstrating that heart rate
variability related to cardiovascular health. HRV and heart rate showed
circadian patterns in ischemic events and heart failure, presenting
higher risk of heart failure at higher levels of heart rate during the
night and higher risk of ischemic events. Hence, both long-term
measurement and hourly measures conveys information about risk at are
needed to whether modification of long-term or hourly measures can have
sustained preventive effect on cardiovascular disease and mortality to
elucidate the role of HRV.
...
events, heart failure, and all-cause mortality, highlighting HRV as an
important marker of cardiovascular health. Both HRV and heart rate
...
further cardiovascular assessment or intervention.

While pathogenic pathways leading to CVD risk are similar across glucose
