...
\frontmatter
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, sharp corners, frame hidden, enhanced, boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}, interior hidden]}{\end{tcolorbox}}\fi
...
leading to hospitalization\textsuperscript{10}.
...
higher HbA1c values among non-diabetic individuals\textsuperscript{25}.
...
levels of 5.7\% to 6.5\%\textsuperscript{26}, in addition to prediabetes
...
formation\textsuperscript{27}. The autonomic nervous system reaches the
...
lowered by reducing sympathetic nerve density\textsuperscript{28}. In
...
data from the Rotterdam Study\textsuperscript{29}. As plaques develop,
...
carotid atherosclerosis\textsuperscript{30}. However, as was asses only
...
ischemia\textsuperscript{31}. In our week-long recordings, our data
...
{[}\textsuperscript{\textbf{colechristopherr?}}.{]}\textsuperscript{32}.
...
diabetes\textsuperscript{33}. This supports autonomic dysfunctions role
...
attention\textsuperscript{34}. As increased sympathetic nervous system
...
complex\textsuperscript{35}. On one hand, autonomic dysfunction may
...
pressure\textsuperscript{36}. Therefore, arterial stiffness may have an
...
remodelling\textsuperscript{37}. In contrast to MACE outcomes, findings
...
diabetes\textsuperscript{38}. This suggest regardless of the direction
...
diabetes compared to people without diabetes\textsuperscript{39}. In
...
{[}\textsuperscript{40}{]}\textsuperscript{41}. SDANN and SDNNi aim to
...
night hours\textsuperscript{41}. Thus, although long-term HRV may lack
...
short-term trials\textsuperscript{42}. This may seem conflicting with
...
{[}\textsuperscript{43}{]}\textsuperscript{44}. However, most biomarkers
...
diabetes\textsuperscript{45} and stroke in older
adults\textsuperscript{46}. However, a limitation of these studies is
...
{[}\textsuperscript{41}{]}\textsuperscript{47}. High-intensity interval
...
{[}\textsuperscript{33}{]}\textsuperscript{40}. In Study II, we observed
...
patterns in response in the daily cycle that is linked to CVD risk.
...
From a clinical perspective, CART offers a practical approach to
screening for autonomic dysfunction, as the test has been shown to be
reliable\textsuperscript{48}. It is non-invasive and typically takes 8
to 10 minutes to complete. While some CART indices may be influenced by
the time of day or recent physical activity, these effects are generally
considered minimal. Additionally, no impact of caffeine intake on the
reference age-specific values was observed\textsuperscript{49}.

In Study III, we demonstrated a relationship between CAN and cardiac
dysfunction, as measured by NT-proBNP. Depsite . Heart failure is
characterized by both structural and functional changes in the heart,
such as left ventricular dysfunction, which can be assessed using
echocardiography. However, the link between these structural and
functional changes and their impact on systolic and diastolic pumping
function in relation to CAN remains to be fully understood. Furthermore,
the diagnostic and prognostic value of CAN, particularly its sensitivity
and specificity in detecting HFrEF and HFpEF, requires further
investigation.
...
{[}Closer attention to the mechanisms underlying autonomic dysfunction
offers promising opportunities for identifying new intervention targets.
While it is plausible that multifactorial risk management may slow the
progression of arterial stiffening in part by modulating autonomic
function, it remains unproven whether direct modification of heart rate
variability (HRV) itself causally reduces cardiovascular disease (CVD)
risk. Recent Mendelian randomization studies have emerged as a valuable
tool to explore such causal relationships, offering unconfounded
estimates by using genetic variants as proxies for exposures.

. These studies can provide a first line of evidence to assess whether
HRV is a modifiable causal factor in CVD development. Furthermore,
...
include HRV measurements to enable structured mediation analyses and
better understand the role of autonomic function in cardiovascular
outcomes.{]}
...
effect of lifestyle intervention in preventing type 2
diabetes\textsuperscript{53}. However, it remains unclear to what extent
this modification applies to cardiovascular outcomes, and whether the
intervention was more effective among individuals with lower HRV.
...
\leavevmode\vadjust pre{\hypertarget{ref-americandiabetesassociationprofessionalpracticecommittee2023}{}}%
\CSLLeftMargin{26 }%
