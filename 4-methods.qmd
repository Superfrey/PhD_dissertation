...
::: center
![Study populations](images/cohort_map.png){width="8in"}
:::
...
::: {layout-ncol="1"}
![Heart rate variability. (Source: Author)](images/measurements_hrv.png){width="7in"}
:::
...
Time-domain measures of HRV are based on the statistical distribution of normal-to-normal (NN) heartbeat intervals. Description of time-domain indices are summarized in box 1.
